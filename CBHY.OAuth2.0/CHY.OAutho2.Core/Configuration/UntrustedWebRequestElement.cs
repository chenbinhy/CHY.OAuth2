...
{
    public class UntrustedWebRequestElement : ConfigurationElement
    {
        ...
        /// </summary>
        public const string WhitelistHostsConfigName = "whitelistHosts";

        /// <summary>
        /// Gets the name of the @whitelistHostsRegex attribute.
        /// </summary>
        public const string WhitelistHostsRegexConfigName = "whitelistHostsRegex";

        /// <summary>
        /// Gets the name of the @blacklistHosts attribute.
        /// </summary>
        public const string BlacklistHostsConfigName = "blacklistHosts";

        /// <summary>
        /// Gets the name of the @blacklistHostsRegex attribute.
        /// </summary>
        public const string BlacklistHostsRegexConfigName = "blacklistHostsRegex";
