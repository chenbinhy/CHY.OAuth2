...
namespace CHY.OAuth2.Core.Configuration
{
    ...
    {/// <summary>
        ...
        public TimeSpan MaximumMessageLifetimeNoSkew
        {
        ...
        public bool RelaxSslRequirements
        {
        ...
        public UntrustedWebRequestElement UntrustedWebRequest
        {
        ...
        public TypeConfigurationElement<IEmbeddedResourceRetrieval> EmbeddedResourceRetrievalProvider
        {
