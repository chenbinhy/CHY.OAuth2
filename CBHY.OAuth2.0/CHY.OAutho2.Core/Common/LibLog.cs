...
namespace CHY.OAuth2.Core.Common
{
    /// <summary>
...
namespace CHY.OAuth2.Core.Common
{
    ...
    public class EntLibLogProvider : ILogProvider
    {
        ...
        public class EntLibLogger : ILog
        {
            ...
            public EntLibLogger(string loggerName, Action<string, string, TraceEventType> writeLog, Func<string, TraceEventType, bool> shouldLog)
            {
